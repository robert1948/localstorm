      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex space-x-6 items-center">
            ...
            <Link to="/how-it-works" className="hover:underline py-3 px-4 rounded transition-colors hover:bg-blue-700 text-lg font-medium">
              How It Works
            </Link>
            <Link to="/" className="bg-white text-blue-600 hover:bg-gray-100 py-3 px-6 rounded-lg transition-colors text-lg font-semibold">
              Home
            </Link>
          </div>
