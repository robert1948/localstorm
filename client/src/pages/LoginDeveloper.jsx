      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Access your developer dashboard and earnings
          </p>
        </div>
        ...
        <div className="bg-white py-8 px-6 shadow-lg rounded-lg">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Link
                to="/register"
                className="w-full inline-flex justify-center py-2 px-4 border border-purple-300 rounded-md shadow-sm bg-purple-50 text-sm font-medium text-purple-600 hover:bg-purple-100"
              >
          ...
          <div className="mt-6 bg-purple-50 p-4 rounded-lg">
            <h4 className="font-medium text-purple-800 mb-2">💰 Developer Benefits</h4>
            <ul className="text-sm text-purple-700 space-y-1">
              <li>• Earn 30% revenue share from your AI agents</li>
              <li>• Real-time earnings analytics</li>
              <li>• Access to comprehensive development tools</li>
